...
var format_XXII_3 = new ol.format.GeoJSON();
var features_XXII_3 = format_XXII_3.readFeatures(json_XXII_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3825'});
var jsonSource_XXII_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_XXII_3.addFeatures(features_XXII_3);
var lyr_XXII_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_XXII_3, 
                style: style_XXII_3,
                interactive: true,
                title: '<img src="styles/legend/XXII_3.png" /> 鋼筋水泥建築XXII'
            });

lyr_Google_0.setVisible(true);lyr_1975_1.setVisible(true);lyr_2016_2.setVisible(true);lyr_XXII_3.setVisible(true);
var layersList = [lyr_Google_0,lyr_1975_1,lyr_2016_2,lyr_XXII_3];
lyr_2016_2.set('fieldAliases', {'樓層數': '樓層數', });
lyr_XXII_3.set('fieldAliases', {'樓層數': '樓層數', });
lyr_2016_2.set('fieldImages', {'樓層數': 'TextEdit', });
lyr_XXII_3.set('fieldImages', {'樓層數': '', });
lyr_2016_2.set('fieldLabels', {'樓層數': 'header label', });
lyr_XXII_3.set('fieldLabels', {'樓層數': 'header label', });
lyr_XXII_3.on('precompose', function(evt) {
